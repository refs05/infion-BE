...
func TestMain(m *testing.M) {
	commentsUsecase = comments.NewCommentsUsecase(&commentsRepository, 2, &repliesRepository, &likeCommentsRepository)
	repliesDomain = replies.Domain{
		ID:        1,
		CommentID: 1,
		UserID:    1,
...
func TestGetByID(t *testing.T){
	t.Run("GetByID | Valid", func(t *testing.T) {
		...
		likeCommentsRepository.On("CountByCommentID", mock.Anything, mock.AnythingOfType("int")).Return(1, nil).Once()
		repliesRepository.On("CountByCommentID", mock.Anything, mock.AnythingOfType("int")).Return(1, nil).Once()
	...
	t.Run("Replies | InValid", func(t *testing.T) {
		commentsRepository.On("GetByID", mock.Anything, mock.AnythingOfType("int")).Return(commentsDomain, nil).Once()
	...
	t.Run("LikeCount | InValid", func(t *testing.T) {
		commentsRepository.On("GetByID", mock.Anything, mock.AnythingOfType("int")).Return(commentsDomain, nil).Once()
		repliesRepository.On("GetRepliesByCommentID", mock.Anything, mock.AnythingOfType("int")).Return([]replies.Domain{repliesDomain}, nil).Once()
		likeCommentsRepository.On("CountByCommentID", mock.Anything, mock.AnythingOfType("int")).Return(0, businesses.ErrInternalServer).Once()
	...
	t.Run("ReplyCount | InValid", func(t *testing.T) {
		commentsRepository.On("GetByID", mock.Anything, mock.AnythingOfType("int")).Return(commentsDomain, nil).Once()
		repliesRepository.On("GetRepliesByCommentID", mock.Anything, mock.AnythingOfType("int")).Return([]replies.Domain{repliesDomain}, nil).Once()
		likeCommentsRepository.On("CountByCommentID", mock.Anything, mock.AnythingOfType("int")).Return(1, nil).Once()
		repliesRepository.On("CountByCommentID", mock.Anything, mock.AnythingOfType("int")).Return(0, businesses.ErrInternalServer).Once()
